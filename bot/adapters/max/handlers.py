    ...
    try:
        ...
        for i, user_data in enumerate(leaderboard[:10], start=1):
            ...
            rating_text += (
                ...
                f"({user_data['lessons_completed']} уроков){user_marker}\n"
            )
        ...
        if user_rank > 10:
            ...
            rating_text += (
                ...
                f"({user_progress['lessons_completed']} уроков) ← <b>Вы</b>\n"
            )
    ...
    try:
        ...
        if isinstance(progress, tuple):
            ...
            text = (
                ...
                f"✅ <b>Уроков пройдено:</b> {progress[1]['lessons_completed']} / {progress[1]['total_lessons']}\n"
